...
\begin{document}
    \singlespacing
    \name{Jim Tran Kelly}
    \tagline{Full-Stack Developer \& Recent Graduate}
    \personalinfo{
    ...
    % or XeLaTeX; if wanting to use \orcid or other 'academicons' commands.
        ...
        \phone{+61412561162}
        \homepage{http://jim-t-kelly.web.app}
    ...
    % Enter experience fields
        \cvevent{Deloitte}{Graduate Analyst}{March, 2022 -- Present}{CBD, Melbourne}
    	\begin{itemize}
    		\item Worked with clients to enable them to disrupt industries before industries disrupt them. Built and designed business solutions that are powered by modern technology platforms that run on premise, in the cloud, or a hybrid of both.
    	\end{itemize}
    	\cvevent{Digital Purpose}{Full-Stack Developer}{March, 2021 -- March, 2022}{West End, Brisbane}
	\begin{itemize}
	...
	\end{itemize}
    	\cvevent{FutureNet}{Undergraduate Software Engineer}{November, 2020 -- March, 2021}{West End, Brisbane}
        \begin{itemize}
       ...
       \end{itemize}
        ...
        \cvevent{}{Senior Bartender}{Jul 2018 -- Dec 2018}{}
        \cvevent{}{Floor Attendant (Glassy)}{Nov 2017 -- Jul 2018}{}
    \cvsection{Education}
    	\cvevent{Bachelor of Information Technology (Computer Science)}{Queensland University of Technology}{Feb 2018 -- Nov 2021}{}
	\begin{itemize}
		\item Graduated with distinction.
		\item Majored in Computer Science with minors in Electrical Engineering \& Artificial Intelligence.
		\item Grade Point Average (GPA): 6.45 / 7.0

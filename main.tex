...
\begin{document}
    ...
    % or XeLaTeX; if wanting to use \orcid or other 'academicons' commands.
        ...
        \phone{+61412561162}
        %\homepage{jamestkelly.github.io}
    ...
    % Enter experience fields
        ...
        %%		-> Get confirmation from employer
            \item Assisted with the development of a desktop and mobile application in React Native for Windows, MacOS, Android, and iOS systems.
        \end{itemize}
        \divider
        ...
        \begin{itemize}
            \item Started at the Woolly Mammoth as a glassy and was promoted from glassy to a bar attendant and subsequently a supervisor position after demonstrating competence leading a team; returned to the Woolly Mammoth Alehouse during the Summer holidays after a sustained break to focus on my studies.
        \end{itemize}
    	\divider
	...
	\cvevent{}{Floor Attendant (Glassy)}{Nov 2016 -- Mar 2017}{}
        ...
        \end{itemize}
    	\divider
    	\cvevent{Food \& Beverage Attendant}{The Morrison Hotel}{Feb 2016 -- Jul 2016}{Woolloongabba, Brisbane}
        \begin{itemize}
...
providing customer service in a small team.
	...
	\begin{itemize}
		...
		\item Transitioned \& transferred units from a Bachelor of Electrical Engineering (Honours) to Bachelor of Information Technology (Computer Science) because I felt as though I would gain more satisfaction from a career in software engineering.
    \medskip
\end{document}